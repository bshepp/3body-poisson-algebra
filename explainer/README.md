...
A static webpage that walks readers through the 11 technical terms in the
[OEIS A395423](https://oeis.org/A395423) submission, one interactive widget
at a time. There is no build step; math rendering uses KaTeX loaded from a
CDN.
...
| §8      | Mass invariance                                                | ✅ |
| §9      | SVD rank gap $>10^9$ (exact rank is proved over ℚ)             | ✅ |
