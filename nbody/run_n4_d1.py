...
"""
Priority 4a: N=4, d=1 through Level 2.

Tests spatial dimension independence for N=4.
If the N=4 sequence is the same at d=1 as at d=2,
...
def main():
    ap = argparse.ArgumentParser(
        description="N=4, d=1 Poisson algebra computation")
    ...
    print("=" * 70)
    print("FOUR-BODY 1D  (N=4, d=1, V=1/r)")
    print("Testing d-independence for N=4")
    print("=" * 70)
    print()

    alg = NBodyAlgebra(n_bodies=4, d_spatial=1, potential="1/r")
    ...
    print("\n" + "=" * 70)
    print("N=4, d=1 RESULTS")
    print("=" * 70)
    seq = [dims[lv] for lv in range(args.max_level + 1)]
    print(f"  N=4, d=1 dimension sequence: {seq}")
