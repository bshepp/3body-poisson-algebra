...
- **Mass-invariant for charge-coupled systems** — He, H⁻, Ps⁻, muonic He all give [3, 6, 17, 116] despite vastly different mass ratios
- **Mass-dependent for gravity** — unequal-mass gravitational systems give [3, 5, 13, 69] (broken symmetry reduces algebra dimension)
- **Charge-magnitude-sensitive** — Li⁺ (+3,−1,−1) gives [3, 6, 17, 111]; H₂⁺ (+1,+1,−1) gives [3, 6, 17, 115]
...
1. **For equal-mass or charge-dominated systems**: the sequence [3, 6, 17, 116] is universal across potential types (1/r, 1/r², 1/r³, log, Yukawa, composite), spatial dimensions, and mass ratios.
2. **For unequal-mass gravitational systems** (no charges): broken S₃ symmetry reduces the sequence to [3, 5, 13, 69], consistently across 7 mass configurations (Sun-Earth-Moon, LISA triple BH, etc.).
3. **Charge magnitude matters at level 3**: nuclear charge |Z| > 2 or mixed-sign charge geometries produce small deviations (111 or 115 vs 116) while preserving levels 0–2 exactly.
...
|----------|--------|-----------|----------|--------|
| Gravitational | Sun-Earth-Moon | 1/r | [3, 5, 13, 69] | Complete |
| Gravitational | Sun-Jupiter-Asteroid | 1/r | [3, 5, 13, 69] | Complete |
| Gravitational | Three Cluster Stars | 1/r | [3, 5, 13, 69] | Complete |
| Gravitational | Binary Star + Planet | 1/r | [3, 5, 13, 69] | Complete |
| Gravitational | Three Merging Galaxies | 1/r | [3, 5, 13, 69] | Complete |
| Gravitational | Triple Black Holes (LISA) | 1/r | [3, 5, 13, 69] | Complete |
| Gravitational | Binary BH + Neutron Star | 1/r | [3, 5, 13, 69] | Complete |
...
**Symmetry breaking by mass**: Unequal-mass gravitational systems consistently give [3, 5, 13, 69] — broken S₃ symmetry reduces the algebra dimension. This was observed across 7 gravitational configurations spanning 10 orders of magnitude in mass ratio.

**Mass invariance for charged systems**: When charges couple the bodies, the dimension sequence becomes mass-invariant within each charge class. He (+2,−1,−1) with m_nucleus=7294 and Ps⁻ (+1,−1,−1) with m_positron=1 both give [3, 6, 17, 116]. The charges, not the masses, determine the algebraic structure.
