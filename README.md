...
> **OEIS:** the headline N=3 dimension sequence `3, 6, 17, 116` is registered as [**A395423**](https://oeis.org/A395423) (assigned April 21, 2026). Submission materials and reading-friendly companion in [`OEIS/`](OEIS/).
>
> **Website:** [nbody.briansheppard.com](https://nbody.briansheppard.com) — interactive atlas explorer, curated figures, dataset browser, and per-experiment status tracker.
