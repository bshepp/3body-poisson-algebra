...
>
> **Interactive explainer:** [`explainer/`](explainer/) — a static, no-build scrollytelling walkthrough of the 11 technical terms in the [OEIS A395423](https://oeis.org/A395423) submission (orbit playground, pendulum portrait, bracket calculator, dimension growth, universality, SVD gap, frontier).
