...
*Neural networks produce richer algebraic structures than any physical system in the universe*
...
The neural network produces **3 extra generators**. It breaks a universality that holds across every physical interaction law in nature.
...
- [Seven universality classes](#seven-universality-classes-in-neural-algebras)
- [Width invariance: the neural analog of spatial dimension independence](#width-invariance)
- [Loss function invariance](#loss-function-invariance)
- [Activation invariance](#activation-invariance)
- [Depth scaling](#depth-scaling-more-layers-more-algebra)
- [The physical benchmark](#the-physical-benchmark-116-vs-119)
...
| L1 (\\(z^2\\) proxy) | approx. \\(\|f - t\|\\) | [3, 6, 17, 119] | A |
...
- **Code**: [github.com/bshepp/3body](https://github.com/bshepp/3body)
- **Physics-focused article**: See `hf_article_physics.md` in the repository for the full physical universality story
